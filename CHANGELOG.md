...
### Fixed
- ZIP から複数パッケージをインポートする際、ドメインリロード後にキューが停止し、毎回手動で「すべてインポート」を押す必要があった問題を修正
  - ドメインリロードからの復帰時に残りのエントリを `Pending` に戻していたのを、自動的にキューを再開するよう変更

## [1.3.0] - 2026-04-01

### Changed
- ドラッグ＆ドロップの受付範囲をウィンドウ全体に拡大

## [1.2.0] - 2026-04-01

### Added
- 通知音の停止ボタンを追加（再生中のみ音量スライダー横に表示）
